...
function formTheAoristImperative(verb: string) {
  ...
  if (declension == "thematic") {
    ...
    let aoristAct = `${circumflex + "ον"} ${no_accent + "άτω"} ${
      accent + "ατε"
    } ${no_accent + "άντων / -άτωσαν"}`;
    let aoristPass = `${accent + "αι"} ${no_accent + "άσθω"} ${
      accent + "ασθε"
    } ${no_accent + "άσθων / -άσθωσαν"}`;
    ...
    let aoristAct = `${stem + ""} ${stem + "τω"} ${stem + "τε"} ${
      stem + "ντων"
    }`;
    let aoristPass = `${stem + "σο"} ${stem + "σθω"} ${stem + "σθε"} ${
      stem + "σθων, -σθωσαν"
    }`;
    let aoristActiveArray = aoristAct.split(" ");
    let aoristPassiveArray = aoristPass.split(" ");

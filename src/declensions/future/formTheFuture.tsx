...
function formTheFuture(verb: string) {
  ...
  if (declension == "thematic") {
    ...
    let futureAct = `${stem + "σω"} ${stem + "σεις"} ${stem + "σει"} ${
      stem + "σομεν"
    } ${stem + "σετε"} ${stem + "σουσιν"}`;
    let futurePass = `${stem + "σομαι"} ${stem + "σει"} ${stem + "σεται"} ${
      no_accent + "σόμεθα"
    } ${stem + "σεσθε"} ${stem + "σονται"}`;
    ...
    let futureAct = `${stem + "ω"} ${stem + "εις"} ${stem + "ει"} ${
      stem + "ομεν"
    } ${stem + "ετε"} ${stem + "ουσιν"}`;
    let futurePass = `${stem + "ομαι"} ${stem + "εσαι"} ${stem + "εται"} ${
      stem + "όμεθα"
